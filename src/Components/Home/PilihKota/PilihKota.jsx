...
export default function PilihKota(props){
    ...
    return (
        <button className="w-full h-12 mx-auto my-3 border border-gray-300 rounded-lg flex items-center justify-between focus:ring-2 focus:ring-blue-300 focus:ring-offset-2" onClick={() => setShowKotaDropdown(!showKotaDropdown)}>
